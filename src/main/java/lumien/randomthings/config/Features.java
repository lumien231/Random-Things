...
public class Features
{
	...
	@ConfigOption(category = "visual", name = "HideCoordinates", comment = "When set to true the coordinates a position filter point to won't be displayed in its tooltip.")
