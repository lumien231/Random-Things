...
public class GuiEntityDetector extends GuiContainer
{
	...
	public void initGui()
	{
		...
		minusX = new GuiButton(0, this.guiLeft + 15, this.guiTop + 20, 20, 20, "-");
		plusX = new GuiButton(1, this.guiLeft + this.xSize - 35, this.guiTop + 20, 20, 20, "+");

		minusY = new GuiButton(2, this.guiLeft + 15, this.guiTop + 45, 20, 20, "-");
		plusY = new GuiButton(3, this.guiLeft + this.xSize - 35, this.guiTop + 45, 20, 20, "+");

		minusZ = new GuiButton(4, this.guiLeft + 15, this.guiTop + 70, 20, 20, "-");
		plusZ = new GuiButton(5, this.guiLeft + this.xSize - 35, this.guiTop + 70, 20, 20, "+");

		filter = new GuiButton(6, this.guiLeft + 15, this.guiTop + 95, 85, 20, "");

		invert = new GuiCustomButton(7, entityDetector.invert(), this.guiLeft + 15 + 90, this.guiTop + 95, 20, 20, "", background, 140, 0);
	...
	protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY)
	{
		...
		fontRendererObj.drawString(I18n.format("tile.entityDetector.name", new Object[0]), 8, 6, 4210752);

		String radiusX = I18n.format("gui.entityDetector.radiusX", entityDetector.getRangeX());
		fontRendererObj.drawString(radiusX, xSize / 2 - fontRendererObj.getStringWidth(radiusX) / 2, 26, 4210752);

		String radiusY = I18n.format("gui.entityDetector.radiusY", entityDetector.getRangeY());
		fontRendererObj.drawString(radiusY, xSize / 2 - fontRendererObj.getStringWidth(radiusY) / 2, 51, 4210752);

		String radiusZ = I18n.format("gui.entityDetector.radiusZ", entityDetector.getRangeZ());
		fontRendererObj.drawString(radiusZ, xSize / 2 - fontRendererObj.getStringWidth(radiusZ) / 2, 76, 4210752);
