...
public class ContainerRedstoneRemoteStill extends Container {
    InventoryItem remoteInventory;
    EnumHand using;
    ItemStack remoteStack;

    public ContainerRedstoneRemoteStill(EntityPlayer player, World world, int x, int y, int z)
    {
        ...
        if (!remoteStack.isEmpty() && remoteStack.getItem() == ModItems.redstoneRemoteStill)// if player get redstoneRemote
        {
